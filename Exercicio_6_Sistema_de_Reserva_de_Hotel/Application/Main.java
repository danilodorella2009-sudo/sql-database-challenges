package JDBC_1_Pratica.Exercicio_6_Sistema_de_Reserva_de_Hotel.Application;

import JDBC_1_Pratica.Exercicio_6_Sistema_de_Reserva_de_Hotel.Repository.CheckinRepository;
import JDBC_1_Pratica.Exercicio_6_Sistema_de_Reserva_de_Hotel.Repository.QuartosRepository;
import JDBC_1_Pratica.Exercicio_6_Sistema_de_Reserva_de_Hotel.entities.Quarto;
import JDBC_1_Pratica.Exercicio_6_Sistema_de_Reserva_de_Hotel.entities.QuartoSimples;
import JDBC_1_Pratica.Exercicio_6_Sistema_de_Reserva_de_Hotel.entities.QuartoDuplo;
import JDBC_1_Pratica.Exercicio_6_Sistema_de_Reserva_de_Hotel.entities.QuartoSuite;
            ...
            while (continuar) {
                ...
                switch (opcao) {
                    ...
                    case 1 -> {
                        ...
                        Quarto quarto;
                        if (tipoOpcao == 1) quarto = new QuartoSimples(0, numero, 1);
                        else if (tipoOpcao == 2) quarto = new QuartoDuplo(0, numero, 1);
                        else if (tipoOpcao == 3) quarto = new QuartoSuite(0, numero, 1);
                        else { System.out.println("Tipo invalido."); break; }

                        System.out.println("Valor da diaria: R$ " + quarto.getValorDiaria());
                        System.out.print("Quantidade de dias: ");
                        int dias = Integer.parseInt(sc.nextLine());

                        System.out.println("Valor total: R$ " + (quarto.getValorDiaria() * dias));
                        quartosRepo.cadastrar(numero, quarto.getTipoQuarto(), quarto.getValorDiaria(), dias);
                    }
                    ...
                    case 2 -> {
                        ...
                        else { System.out.println("Pagamento invalido."); break; }

                        checkinRepo.cadastrar(nomeCliente, cpf, telefone, dataCheckin,
